...
select
    ...
    lead_changes,
    lead_changes_fourth_quarter                 as q4_lead_changes,
    lead_changes_overtime                       as ot_lead_changes,
    largest_single_play_swing,
    largest_single_play_swing_fourth_quarter    as q4_largest_swing,
    case
...
where plays_with_win_probability_fourth_quarter
      + plays_with_win_probability_overtime > plays_with_win_probability
   or coalesce(lead_changes_fourth_quarter, 0) + coalesce(lead_changes_overtime, 0)
      > lead_changes
   or largest_single_play_swing_fourth_quarter > largest_single_play_swing
