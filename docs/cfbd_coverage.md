...
| `metrics/wp` | CLI | 256 | `stg_game_win_probability` | 16/16 | complete |
| `metrics/wp/pregame` | swept | 8 | `stg_game_pregame_wp` | 8/8 | complete |
| `passing/players/games` | CLI | — | `stg_passing_player_game` | 22/34 | no raw data |
| `passing/players/season` | CLI | — | `stg_passing_player_season` | 18/30 | no raw data |
| `passing/plays` | CLI | — | `stg_passing_play` | 36/39 | no raw data |
| `passing/teams/games` | CLI | — | `stg_passing_team_game` | 20/32 | no raw data |
| `passing/teams/season` | CLI | — | `stg_passing_team_season` | 16/28 | no raw data |
...
| `plays/stats` | CLI | 228 | `stg_play_stat` | 20/20 | complete |
...
| `rushing/players/games` | CLI | — | — | 0/35 | no raw data |
| `rushing/players/season` | CLI | — | — | 0/31 | no raw data |
| `rushing/plays` | CLI | — | — | 0/34 | no raw data |
| `rushing/teams/games` | CLI | — | — | 0/35 | no raw data |
| `rushing/teams/season` | CLI | — | — | 0/31 | no raw data |
